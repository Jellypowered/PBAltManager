...
PBAM.RegisterTab("Talents", "Talents", 2, function(panel)
    ...
    resetBtn:SetScript("OnEnter", function(self)
        ...
        GameTooltip:AddLine("Clear the current talent build selection.", 0.8, 0.8, 0.8, true)
        GameTooltip:Show()
    end)
    ...
    refreshBtn:SetScript("OnEnter", function(self)
        GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
        GameTooltip:SetText("Refresh Talents", 1, 0.82, 0.22, true)
        GameTooltip:AddLine("Request fresh talent spec list and live talent ranks.", 0.8, 0.8, 0.8, true)
        GameTooltip:Show()
    end)
