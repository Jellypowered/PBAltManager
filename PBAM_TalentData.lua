-- Copied/adapted from PlayerbotManager PBM_TalentData.lua for PBAltManager talent grid rendering.
PBAM = PBAM or {}
PBAM.data = PBAM.data or {}
PBAM.data.talent = {}

-- ARROWS --

PBAM.data.talent.arrows = {
["DeathKnight"] = {
[1] = {
...
--  juste après le bloc   PBAM.data.talent.glyphs = { … }
-- =========================================================================
PBAM.data.talent.specGlyphs = {
    WARRIOR = {      -- 1.x
...
do
    ...
    for upperKey, tbl in pairs(PBAM.data.talent.specGlyphs) do
    ...
    PBAM.data.talent.specGlyphs = unified
end
